...
@Component({
  selector: 'app-admin-kozmeticari',
  standalone: true,
  imports: [FormsModule,  CommonModule,TabelaComponent],
  templateUrl: './admin-kozmeticari.component.html',
  styleUrl: './admin-kozmeticari.component.css'
})
export class AdminKozmeticariComponent {
  ...
  ngOnInit(): void {
      ...
      if(koz != null) {
        ...
        this.prikazaniKozmeticari = this.sviKozmeticari.slice(0, 5);
      }
    })
