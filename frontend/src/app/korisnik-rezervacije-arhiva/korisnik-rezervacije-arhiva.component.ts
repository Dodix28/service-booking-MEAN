...
@Component({
  selector: 'app-korisnik-rezervacije-arhiva',
  standalone: true,
  imports: [CommonModule,
      FormsModule,TabelaComponent ],
  templateUrl: './korisnik-rezervacije-arhiva.component.html',
  styleUrl: './korisnik-rezervacije-arhiva.component.css'
})
export class KorisnikRezervacijeArhivaComponent {
        ...
        this.rezervacijaService.dohvatiRezervacijuZaKlijenta(this.ulogovan.kor_ime).subscribe((rez: Rezervacija[]) => {
          if(rez!= null){
            rez.forEach((r:Rezervacija) =>{
             ...
             this.prikazaneRezervacije = this.arhivaRezervacije.slice(0, 5);
